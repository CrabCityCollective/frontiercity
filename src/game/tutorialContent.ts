...
export const VIJANDELIJK_HEILIGDOM_ONTHULD_TEKST =
  "Verkenning heeft een heiligdom blootgelegd dat niet het onze is. Zolang je minstens één Missionaris hebt opgeleid, stroomt nieuwe cultuur van je eigen heiligdommen naar een belegeringsmeter voor dit doel — zonder Missionaris gebeurt er niets. Elke extra Missionaris versnelt de belegering verder.";
