...
- Nog te bouwen: een echte, langere campagnewereld (30-60 streken, hoofdstuk 8/14) met een eigen `CampaignConfig`-instantie voor de Amerikaanse campagne, de worldgen-koppeling die het stichtingspatroon daadwerkelijk speelbaar maakt, en de drie ankers (hoofdstuk 9) inhoudelijk en technisch uitgewerkt. Zie hoofdstuk 13's milestone-tabel voor de voorgestelde vervolgstap (M20).
