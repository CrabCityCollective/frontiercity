...
**Meerdere Missionarissen versnellen de belegering (issue: "Laatste confrontatie tweaken")**
De oorspronkelijke versie van dit mechanisme vereiste alleen dat er *ergens* minstens één Missionaris bestond — een tweede of derde Missionaris voegde daarna niets meer toe, in tegenstelling tot bijvoorbeeld een tweede Soldaat (die wél extra legerwaarde geeft bij een Confrontatie). Dat maakte "meerdere Missionarissen opleiden" een dode keuze. De omgeleide cultuurproductie wordt daarom vermenigvuldigd met het aantal Missionarissen dat de speler heeft, zodat elke extra Missionaris de belegeringsmeter tastbaar sneller laat vollopen — consistent met hoe andere units (Soldaten, Legerkamp) wél schalen met aantal.
...
*Belegeringsdrempel*: **30** cultuur-inkomen per vernietigd vijandelijk Heiligdom (`BELEGERINGSDREMPEL`, `src/game/laagOntgrendeling.ts`) — MVP-richtwaarde, tunebaar. Alleen opgebouwd zolang de speler minstens één Missionaris heeft, en vermenigvuldigd met het aantal Missionarissen (issue: "Laatste confrontatie tweaken", hoofdstuk 11); de meter begint na elke vernietiging weer bij 0.
